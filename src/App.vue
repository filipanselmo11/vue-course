...
<style>
:root {
  --font-primary: Lato, Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji",
    "Segoe UI Emoji", "Segoe UI Symbol";
  --font-display: "IBM Plex Sans", Roboto, Helvetica, Arial, sans-serif,
    "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  --font-code: "IBM Plex Mono", Menlo, Monaco, Consolas, "Liberation Mono", "Courier New",
    monospace;
